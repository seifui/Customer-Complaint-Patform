...
export const ROLES = {
  agent:  {name:'Nadeesha Perera', title:'Call Centre Agent',      init:'NP', team:'Contact Centre',        home:'mine'},
  branch: {name:'Kasun Silva',     title:'Branch / RM Staff',      init:'KS', team:'Colombo Fort Branch',   home:'mine'},
  manager:{name:'Priyantha Fernando', title:'Operations Manager',  init:'PF', team:'Customer Experience',   home:'dash'},
  dev:    {name:'Ishara Jayasuriya', title:'Developer · Digital Banking', init:'IJ', team:'Digital Banking Team', home:'mytasks'},
  ceo:    {name:'Ruwan Wickramasinghe', title:'CEO / MD',          init:'RW', team:'Executive',             home:'dash'},
  // Generic role — any number of departments can each get their own Department
  // Manager account later by adding an entry here with a different `department`.
  // Nothing else in the app needs to change to support a new department.
  dept_manager: {name:'Sanduni Rajapakse', title:'Department Manager — Technology', init:'SR', team:'Technology', department:'Technology', home:'deptqueue'}
};
let currentRole = 'agent';

// The full set of departments a concern can be routed to. Adding a new
// department here (and, optionally, a roster entry below and a dept_manager
// account above) is the only change needed to support it end-to-end.
...
export const CHANNEL_ICON = {
  ...
  'Existing System':'🗄','Digital App':'📱','WhatsApp':'💬'
};
