...
export const ROLES = {
  agent:  {name:'Nadeesha Perera', title:'Call Centre Agent',      init:'NP', team:'Contact Centre',        home:'capture'},
  branch: {name:'Kasun Silva',     title:'Branch / RM Staff',      init:'KS', team:'Colombo Fort Branch',   home:'capture'},
